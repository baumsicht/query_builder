...
class QueryBuilderDialog(QDialog):
    def __init__(self, layer):
        super().__init__()
        self.setWindowTitle("QueryBuilder  –  v0.2.0")
        ...
        # interne Gruppen-Liste und globaler Button
        self.groups = []
        self.add_group()
    ...
    def add_group(self):
        ...
        hl.addWidget(QLabel("Verknüpfung:"))
        hl.addWidget(op)
        hl.addStretch()
    ...
    def add_condition(self, group):
        ...
        op = QComboBox()
        op.addItems(
            ["=", "!=", ">", "<", ">=", "<=", "zwischen", "enthält", "ist leer", "ist nicht leer"]
        )
        ...
        inp2.hide()
        btn_del = QPushButton("❌")
        btn_del.setToolTip("Lösche diese Bedingung")
